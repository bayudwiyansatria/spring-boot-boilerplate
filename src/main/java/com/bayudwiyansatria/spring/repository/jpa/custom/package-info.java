 ...
 *
 * <p>
 * The custom JPA repository layer is responsible for implementing custom data access and
 * persistence logic using Java Persistence API (JPA). It extends the capabilities of the standard
 * JPA repository layer by providing additional methods and functionality tailored to the
